...
def process_text_to_video_task(self, job_id, avatar_image_path, text, voice_id, resolution, speaker_wav_path=None, aspect_ratio="16:9"):
    logger.info(f"[WORKER] Starting text-to-video for job {job_id}")
    try:
