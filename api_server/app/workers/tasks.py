...
from app.core.pipeline.orchestrator import run_text_to_video_pipeline
import logging
...
@celery_app.task(bind=True)
def process_audio_to_video_task(self, job_id, avatar_image_path, audio_file_path, enhance):
