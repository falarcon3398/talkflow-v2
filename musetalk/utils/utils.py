...
def load_all_model():
    audio_processor = Audio2Feature(model_path="./checkpoints/whisper/tiny.pt")
    vae = VAE(model_path = "./checkpoints/sd-vae-ft-mse/")
    unet = UNet(unet_config="./checkpoints/musetalk/musetalk.json",
                model_path ="./checkpoints/musetalk/pytorch_model.bin")
